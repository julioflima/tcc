...
%\usepackage{float}                                 % Incompatível com memoir - usar [htb] em vez de [H]
\usepackage{amsgen}
\usepackage{lipsum}                                 % Usar a simulação de texto Lorem Ipsum
%\usepackage{titlesec}                              % Permite alterar os títulos do documento
\usepackage{tocloft}                                % Permite alterar a formatação do Sumário
\usepackage{etoolbox}                               % Usado para alterar a fonte da Section no Sumário
\usepackage[nogroupskip,nonumberlist,symbols]{glossaries}   % Permite fazer o glossario
...
\usetikzlibrary{positioning,shapes,arrows,shapes.geometric,calc,fit,shadows.blur}  % Bibliotecas TikZ
\usepackage{pgfplots}          % Gráficos nativos em LaTeX
\pgfplotsset{compat=1.18}
\usepackage{fontawesome5}     % Ícones para diagramas
