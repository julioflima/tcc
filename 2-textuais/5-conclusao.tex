...
\begin{alineas}
    ...
    \item A governança é compartilhada entre trabalhador, governo e auditoria através de carteiras multi-sig 2-de-3, onde a auditoria atua como mecanismo de recuperação de chaves;
...
\begin{alineas}
    ...
    \item Elaboração de proposta regulatória para disciplinar a custódia, emissão e negociação de ativos tokenizados no contexto previdenciário.
\end{alineas}
