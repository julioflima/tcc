...
Quanto à abordagem, trata-se de pesquisa qualitativa, fundamentada na análise interpretativa de documentos, legislação, dados econômicos e modelos internacionais, sem utilização de métodos estatísticos como principal meio de análise \cite{creswell2014}.
...
\begin{alineas}
    \item \LaTeX{} para elaboração do documento, utilizando a classe abnTeX2;
    \item Mendeley e Zotero para gerenciamento de referências bibliográficas;
    \item Draw.io para elaboração de diagramas e figuras;
    \item Git para controle de versão do documento.
\end{alineas}
