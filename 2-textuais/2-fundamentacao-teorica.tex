...
\noindent onde $R_T \approx 6.371$ km é o raio médio da Terra. No Equador ($\phi = 0°$), $\cos(0°) = 1$ e a velocidade tangencial atinge seu valor máximo:

$$v_{\text{eq}} = 7{,}27 \times 10^{-5} \times 6{,}371 \times 10^{6} \approx 463 \text{ m/s} \approx 1.667 \text{ km/h}$$

\noindent Já em Cabo Canaveral ($\phi \approx 28{,}5°$):

$$v_{\text{CC}} = 463 \times \cos(28{,}5°) \approx 463 \times 0{,}879 \approx 407 \text{ m/s}$$

A diferença de $\Delta v \approx 56$ m/s pode parecer modesta, mas em astrodinâmica cada m/s adicional de $\Delta v$ exige combustível extra de forma \textbf{exponencial}, conforme a equação de Tsiolkovsky \cite{wertz2011}:
...
Para atingir uma órbita terrestre baixa (LEO), o foguete precisa alcançar aproximadamente 7.800 m/s. Cada m/s ``gratuito'' fornecido pela rotação terrestre reduz o $\Delta v$ que o propulsor precisa gerar. Assim, os $\sim$56 m/s extras do Equador em relação a Cabo Canaveral representam, na prática, centenas de quilos a menos de combustível por tonelada de carga útil --- uma vantagem que se traduz diretamente em economia financeira ou em capacidade adicional de carga.
