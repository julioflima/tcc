...
O problema do espaço aéreo merece atenção especial. A cada lançamento de foguete em Cabo Canaveral, a \textit{Federal Aviation Administration} (FAA) é obrigada a emitir \textit{Temporary Flight Restrictions} (TFRs) --- zonas de exclusão aérea que proíbem voos comerciais em amplas áreas sobre o Oceano Atlântico e o litoral da Flórida \cite{faa2023}. Com a cadência de lançamentos da SpaceX ultrapassando 90 missões anuais em 2023, essas restrições tornaram-se fonte recorrente de conflitos com a aviação comercial.

Conforme reportado por \citeonline{murray2024}, os lançamentos frequentes a partir da costa leste da Flórida já provocam atrasos significativos em rotas comerciais, afetando companhias aéreas que operam nos corredores entre a América do Norte e o Caribe/América do Sul. A FAA precisa coordenar janelas de lançamento com o tráfego aéreo de três grandes aeroportos da região --- Orlando (MCO), Miami (MIA) e Fort Lauderdale (FLL) ---, um dos espaços aéreos mais congestionados do mundo. Em diversos casos, voos comerciais foram desviados ou atrasados em até 45 minutos para acomodar uma única janela de lançamento.

Essa tensão tende a se agravar: com a projeção de mais de 150 lançamentos anuais nos próximos anos, o espaço aéreo da Flórida aproxima-se de um ponto de saturação. Uma base em Sobral eliminaria completamente esse problema --- o tráfego aéreo sobre o semiárido cearense é praticamente inexistente comparado à Flórida, e não há aeroportos de grande porte nas proximidades da trajetória de lançamento, permitindo uma cadência virtualmente ilimitada sem impacto na aviação civil.
