...
\begin{figure}[htb]
    ...
    % Cenários de uso
    \node[font=\small, align=left, text width=4.5cm, fill=gray!5, rounded corners=3pt, inner sep=8pt] at (-2, 0.5) {
        \textbf{Combinações válidas:} \\[4pt]
        {\color{black}\faCheck} Trabalhador + Governo \\[3pt]
        {\color{black}\faCheck} Trabalhador + Auditoria \\[3pt]
        {\color{black}\faCheck} Governo + Auditoria
    };
