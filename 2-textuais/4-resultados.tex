...
\begin{figure}[htb]
    ...
    % ── tons de cinza ──
    \definecolor{cSlate}{HTML}{404040}
    \begin{tikzpicture}[
        % ── estilos ──
        actor/.style={
        ...
        layerlbl/.style={
            font=\sffamily\bfseries\fontsize{5}{6}\selectfont,
            rotate=90, anchor=south, text=gray!50,
            inner sep=1pt
        },
        conn/.style={->, >=stealth, line width=0.9pt, black!35},
        biconn/.style={<->, >=stealth, line width=0.9pt, black!35},
        flowlbl/.style={font=\tiny\sffamily, fill=white, inner sep=1.5pt, text=black!60, rounded corners=1pt}
    ]
    ...
    % ═══════════════════════════════════════
    \fill[black!4, rounded corners=8pt] (-6.6, 5.35) rectangle (6.6, 7.15);
    \draw[black!15, rounded corners=8pt, line width=0.5pt] (-6.6, 5.35) rectangle (6.6, 7.15);
    % Label
    \node[layerlbl] at (-5.95, 6.25) {INTERFACE};
    % Cards
    \node[card] (app)    at (-3.5, 6.25) {\faDesktop\\[2pt] App/Web\\[-1pt]do Trabalhador};
    \node[card] (folha)  at (0, 6.25)    {\faFileCode\\[2pt] Sistema\\[-1pt]de Folha};
    \node[card] (painel) at (3.5, 6.25)  {\faUniversity\\[2pt] Painel\\[-1pt]Governamental};
    ...
    % ═══════════════════════════════════════
    \fill[black!6, rounded corners=8pt] (-6.6, 3.15) rectangle (6.6, 5.0);
    \draw[black!15, rounded corners=8pt, line width=0.5pt] (-6.6, 3.15) rectangle (6.6, 5.0);
    % Label
    \node[layerlbl] at (-5.95, 4.075) {GOVERNANÇA};
    % Cards
    \node[card] (k1) at (-3.5, 4.1) {\faKey\\[2pt] Chave\\[-1pt]Trabalhador};
    \node[card] (k2) at (0, 4.1)    {\faKey\\[2pt] Chave\\[-1pt]Governo};
    \node[card] (k3) at (3.5, 4.1)  {\faKey\\[2pt] Chave\\[-1pt]Auditoria};
    % Badge multi-sig
    \node[fill=black!6, draw=black!25, rounded corners=3pt, font=\sffamily\tiny\bfseries, text=black!60, inner sep=3pt, line width=0.4pt, align=center] at (5.7, 4.1) {Multi-sig\\2-de-3};
    ...
    % ═══════════════════════════════════════
    \fill[black!8, rounded corners=8pt] (-6.6, 0.85) rectangle (6.6, 2.8);
    \draw[black!15, rounded corners=8pt, line width=0.5pt] (-6.6, 0.85) rectangle (6.6, 2.8);
    % Label
    \node[layerlbl] at (-5.95, 1.825) {CONTRATOS};
    % Cards
    \node[card] (c1) at (-4.2, 1.85) {\faPiggyBank\\[2pt] Contribuição};
    \node[card] (c2) at (-1.4, 1.85) {\faChartLine\\[2pt] Investimento};
    \node[card] (c3) at (1.4, 1.85)  {\faUsers\\[2pt] Herança};
    \node[card] (c4) at (4.2, 1.85)  {\faUserShield\\[2pt] Compliance};
    ...
    % ═══════════════════════════════════════
    \fill[black!10, rounded corners=8pt] (-6.6, -1.45) rectangle (6.6, 0.5);
    \draw[black!15, rounded corners=8pt, line width=0.5pt] (-6.6, -1.45) rectangle (6.6, 0.5);
    % Label
    \node[layerlbl] at (-5.95, -0.475) {BLOCKCHAIN};
    % Cards
    \node[card] (t1) at (-3.5, -0.45) {\faCoins\\[2pt] Tokens\\[-1pt]BRL / Ativos};
    \node[card] (t2) at (0, -0.45)    {\faBook\\[2pt] Livro de\\[-1pt]Ordens};
    \node[card] (t3) at (3.5, -0.45)  {\faLock\\[2pt] Módulo de\\[-1pt]Privacidade};
