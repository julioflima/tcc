...
\begin{figure}[htb]
    ...
    % Badge multi-sig
    \node[fill=black!6, draw=black!25, rounded corners=3pt, font=\sffamily\tiny\bfseries, text=black!60, inner sep=3pt, line width=0.4pt] at (5.7, 4.7) {Multi-sig 2-de-3};
