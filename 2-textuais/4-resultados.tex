...
Esta abordagem evita distorções do sistema jurídico atual. O caso de Elize Matsunaga ilustra a falha do modelo vigente: condenada pelo homicídio do marido Marcos Matsunaga em 2012, ela ainda assim herdou parte do patrimônio da vítima, conforme as regras de sucessão brasileiras que priorizam vínculos formais sobre a vontade presumida do falecido \cite{matsunaga2012}. No sistema proposto, apenas os beneficiários \textit{expressamente designados} pelo titular --- e que possuam a chave privada compartilhada em vida --- teriam acesso ao patrimônio, eliminando heranças indesejadas decorrentes de vínculos legais que não refletem a real vontade do trabalhador.
...
A Figura \ref{fig:transicao-geracional} ilustra esta dinâmica, mostrando a relação entre idade e valor \textit{líquido} devido --- ou seja, contribuições menos benefícios já recebidos.
...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}[scale=0.85]
        ...
        % Área de migração sêniores (50% do orçamento - área pequena pois valores baixos por pessoa)
        \fill[orange!30, opacity=0.5] (8,0) -- (8,4.0) -- (9,2.5) -- (10,1.2) -- (11,0.5) -- (12,0.2) -- (13,0.1) -- (13,0) -- cycle;
        \node[orange!70!black, font=\footnotesize, align=center] at (10.5, 3.0) {50\%};
        ...
        \draw[->, very thick, orange!70!black] (12.5, -0.8) -- (8.5, -0.8) node[midway, below] {\footnotesize $\leftarrow$ Sêniores};
        ...
        \node[font=\scriptsize, align=center, text width=2.5cm] at (10.5, 5.0) {Muitas faixas\\etárias cobertas};
        \draw[->, gray, thin] (10.5, 4.5) -- (10.5, 3.3);
        
        % Texto explicativo sobre as áreas
        \node[align=center, font=\tiny] at (7, -1.5) {
            \begin{minipage}{6cm}
                Ambas as áreas destacadas no gráfico --- tanto para jovens quanto para sêniores --- são pequenas, pois os valores devidos por pessoa em cada grupo são baixos. Nos jovens, o saldo é baixo porque pouco contribuíram; nos idosos, porque já receberam boa parte do que aportaram em vida. Assim, a simetria das áreas representa a divisão igualitária do orçamento, mas não implica grandes volumes financeiros individuais em nenhuma das pontas.
            \end{minipage}
        };
    \end{tikzpicture}
    \fonte{Elaborado pelo autor com base em dados do Anuário Estatístico da Previdência Social \cite{aeps2023}.}
\end{figure}

Esta estratégia bidirecional apresenta vantagens significativas:

\begin{alineas}
    \item \textbf{Viabilidade financeira}: Com o mesmo orçamento, a frente sênior avança mais rápido em número de faixas etárias;
...
\begin{figure}[htb]
    ...
    \begin{tikzpicture}[
        ...
        % Observador
        \node[below=1.5cm of normal] (obs1) {\includegraphics[width=0.8cm]{example-image}};
        \node[below=0.3cm of obs1] {\small Visível};
        
        \node[below=1.5cm of ringct] (obs2) {\includegraphics[width=0.8cm]{example-image}};
