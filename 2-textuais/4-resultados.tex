...
\begin{figure}[htb]
    ...
    % Badge multi-sig
    \node[fill=cAmber!12, draw=cAmber!40, rounded corners=3pt, font=\sffamily\tiny\bfseries, text=cAmber!80!black, inner sep=3pt, line width=0.4pt] at (0, 3.38) {Multi-sig 2-de-3};
