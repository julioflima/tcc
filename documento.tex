...
% \setlength{\mathindent}{0pt} % Removido para centralizar equações
...
\titulo{Proposta de Reforma Previdenciária: Um Mercado Financeiro Poupador via Blockchain como Alternativa ao INSS e FGTS}
\data{2026}
\local{Sobral}
